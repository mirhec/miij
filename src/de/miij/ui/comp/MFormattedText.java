...
public class MFormattedText extends MTextField implements ILanguageSupport
{
	...
	/**
	 * Speichert alle gedr&uuml;ckten Action-Keys, die den weiteren Programmfluss
	 * beeinflussen w&uuml;rden, wenn man sie nicht feststellen k&ouml;nnte (z.B. esc oder
	 * del).
	 */
	 ...
	 * grunds&auml;tzlich maximal 31 zugelassen. Des weiteren wird &uuml;berpr&uuml;ft, ob schon
	 * ein Monat eingegeben wurde. Ist dies der Fall, so werden nur dijenigen
	 * Zahlen zugelassen, f&uuml;r die es in dem eingegebenen Monat auch Tage gibt.
	 * 
	 * @param i
	 */
	 ...
	 * CaretPosition um eins erh&ouml;ht und die Methode backspace erneut aufgerufen.
	 */
	 ...
	 * ist. Ist dies nicht der Fall, wird nur die CaretPosition um eins erh&ouml;ht,
	...
	/**
	 * &Uuml;berpr&uuml;ft den eingegebenen Text auf G&uuml;ltigkeit und Vollst&auml;ndigkeit.
	 * 
