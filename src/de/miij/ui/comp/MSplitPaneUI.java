 ...
 * @author Mirko Hecky
 */
public class MSplitPaneUI extends BasicSplitPaneUI
{
	public BasicSplitPaneDivider createDefaultDivider()
	{
		return new MSplitPaneDivider(this);
	}
	...
	static void loadActionMap(MLazyActionMap map) {
    ...
    protected void installKeyboardActions() {
        ...
        SwingUtilities.replaceUIInputMap(splitPane, JComponent.
                                       WHEN_ANCESTOR_OF_FOCUSED_COMPONENT,
                                       km);
        MLazyActionMap.installLazyActionMap(splitPane, BasicSplitPaneUI.class,
                                           "SplitPane.actionMap");
    }
	...
	private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent ev) {
            ...
            MSplitPaneUI ui = null;
			
			if (MSplitPaneUI.class.isInstance(splitPane.getUI())) {
				ui = (MSplitPaneUI) splitPane.getUI();
			}
