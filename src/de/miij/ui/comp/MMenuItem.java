...
public class MMenuItem extends JMenuItem implements ILanguageSupport
{
	...
	/**
	 * Diesem Konstruktor wird ein String-Parameter &uuml;bergeben, welcher zum einen
	 * den Text, zum anderen den Shortcut und Mnemonic enth&auml;lt, z.B.
	 * "&Speichern@control S". Die Shortcuts m&uuml;ssen so wie in der Methode 
	 * <b><i>getKeyStroke( String keyStroke )</i></b> der Klasse <b>KeyStroke</b>
