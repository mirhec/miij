...
public class ArrayUtil
{
	...
	/**
	 * Sortiert das Array um, so dass der &uuml;bergebene Index ab
	 * sofort 0 ist.
	 * 
	 * @param arr
	 * @param index
	...
	/**
	 * Diese Methode liefert ein neues String[] zur&uuml;ck. Daf&uuml;r wird ein String
	 * (str) ben&ouml;tigt, in welchem Informationen bzw. Werte anhand des Trenneers
	 * (separator) gespeichert sind. Diese Methode kon- vertiert den String in
	 * ein Array.
	 * 
	 * @param str
	 * @param separator
	...
	/**
	 * Diese Methode liefert einen String zur&uuml;ck. Daf&uuml;r wird ein String[]
	 &ouml; ben&ouml;tigt, in welchem Informationen bzw. Werte anhand des Trenneers
	 * (separator) gespeichert sind. Diese Methode kon- vertiert das Array in
	 * einen String.
	 * 
	 * @param arr
	 * @param separator
	...
	/**
	 * Diese Methode liefert einen String zur&uuml;ck. Daf&uuml;r wird ein String[&ouml;
	 * ben&ouml;tigt, in welchem Informationen bzw. Werte anhand des Trenneers
	 * (separator) gespeichert sind. Diese Methode kon- vertiert das Array in
	 * einen String.
	 * 
	 * @param arr
	...
	/**
	 * Diese Methode &uuml;berpr&uuml;ft, ob das &uuml;bergebene Object (actElement) in dem
	 * &uuml;bergebenen Array vorkommt. Ist dies der Fall, so wird das n&auml;chste Element
	 * (bzw. das erste, wenn das aktuelle Element das letzte ist) zur&uuml;ck gegeben.
	 * 
	 * @param arr
	 * @param actElement
	...
	/**
	 * Diese Methode &uuml;berpr&uuml;ft, ob das &uuml;bergebene Object (actElement) in dem
	 * &uuml;bergebenen Array vorkommt. Ist dies der Fall, so wird das vorherige
	 * Element (bzw. das letzte, wenn das aktuelle Element das erste ist) zur&uuml;ck
	 * gegeben.
	 * 
	 * @param arr
	 * @param actElement
	...
	/**
	 * Diese Methode liefert den Index des &uuml;bergebenen Elements zur&uuml;ck.
	 * 
	 * @param arr
	 * @param element
	 * @return
	 ...
	 * 
	 * @param h
	 * @param keySort Ob nach den Schl&uuml;sseln, oder den Werten sortiert werden soll
	 * @return
	 */
	...
	/**
	 * Diese Methode &uuml;berpr&uuml;ft, ob das &uuml;bergebene Objekt in dem &uuml;bergebenen Array
	 * existiert.
	 * 
	 * @param arr
	 * @param obj
	...
	/**
	 * Diese Methode &uuml;berpr&uuml;ft, ob alle Werte des &uuml;bergebenen Arrays isIn in dem
	 * Array arr vorkommen.
	 * 
	 * @param arr
	 * @param isIn
	...
	/**
	 * Diese Methode f&uuml;gt einem vorhandenen Array einen weiteren Eintrag an das 
	 * Ende hinzu. Dabei wird nicht &uuml;berpr&uuml;ft, ob die Objekte vom Selben Datentyp
	 * sind.
	 * 
	 * @param arr
	 * @param insert
