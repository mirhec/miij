...
/**
 * In this class you will find methods to create conditions,
 * that are used with XMLDatabase to make a select.
 * 
 * To use this class correctly you have to understand the difference
 * between conditions and restrictions. A condition holds an identifier
 * and a value (or more values). A restriction holds two identifiers that
 * will be compared after all conditions have been executed.
 * 
 * @author Mirhec
 */
public abstract class XMLSelector
{
	 ...
	 * condition you have to define an identifier to hold one or more
	 * values. To declare more than one possible value for the identifier
	 * you have to pass an String[] as second argument.
	 * 
	...
	{
		Conditions.add( new XMLCondition( identifier , new String[] { value } ) );
	}
	...
	/**
	 * This method you can use to describe a new restriction. To create
	 * a restriction you have to define two identifiers, that will be
	 * compared, after all other conditions are executed.
	 * 
	 * E.g. restriction( "Visitor." + XMLRow.ID , "Drink." + XMLRow.PARENT_ID )
	 * 
	 * @param identifier1
	 * @param identifier2
	 * @param join Either XMLRestriction.LEFT or XMLRestriction.RIGHT. Standard is LEFT.
	 */
